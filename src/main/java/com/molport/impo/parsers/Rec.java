...
public class Rec {
    ...
    public String toString() {
        return  "fileName=" + fileName + " ["+lineNum+"], catNum=" + catNum + ", packUnit=" + packUnitList + ", quantityMeasure=" + qtyMeasureList + ", price=" + priceList + ", curr=" + currList + ", priceGroup=" + priceGroup + ", casNum=" + casNum + 
                " ,Errors: "+errors;
    }
